...
> ![image](https://github.com/uni-cs-notes/cs50-notes/assets/160413612/8dd851ee-47a1-45d6-8551-ec7cb14ddc03)
...
# Addresses
* In weeks past, you may recall our artist rendering of concurrent blocks of memory. Applying hexadecimal numbering to each of these blocks of memory
> you can visualize these as follows:
> ![image](https://github.com/uni-cs-notes/cs50-notes/assets/160413612/8a58707c-7906-4401-8095-4f5775f7d934)
...
> ![image](https://github.com/uni-cs-notes/cs50-notes/assets/160413612/b557471f-bce8-44cb-b5d4-980e3e8454cd)
...
```
* `Notice the %p, which allows us to view the address of a location in memory. &n can be literally
translated as “the address of n.” Executing this code will return an address of memory beginning with 0x.`
...
> ![image](https://github.com/uni-cs-notes/cs50-notes/assets/160413612/c6aab161-ee33-46c2-a1d0-eca0c442d4c0)
...
> ![image](https://github.com/uni-cs-notes/cs50-notes/assets/160413612/bf6a6702-abf8-4865-8ad5-1f41279a31c7)
...
> ![image](https://github.com/uni-cs-notes/cs50-notes/assets/160413612/60d953d3-261b-4a8d-8eb1-1edb3a24b0be)

* The string HI with an exclaimation point stored in memory

* However, what is s really? Where is the s stored in memory? As you can imagine, s needs to be stored somewhere.
> You can visualize the relationship of s to the string as follows:
> ![image](https://github.com/uni-cs-notes/cs50-notes/assets/160413612/1ed04f75-f9e1-4f2e-94d9-67288bece339)
...
> ![image](https://github.com/uni-cs-notes/cs50-notes/assets/160413612/ac9764c2-1b5d-4a63-99ae-0b92e517fd66)
> For clarity, you can see how the following image illustrates pointers pointing to two separate locations in memory:
> ![image](https://github.com/uni-cs-notes/cs50-notes/assets/160413612/5ce03c65-c497-43ea-a775-57adf8ed5ec3)
* Modify your code as follows:
```
#include <cs50.h>
#include <stdio.h>
...
> ![image](https://github.com/uni-cs-notes/cs50-notes/assets/160413612/ec15ffac-b6f6-41da-b258-4dd8c878ab8a)
...
> ![image](https://github.com/uni-cs-notes/cs50-notes/assets/160413612/f2999929-9430-4a06-8c5a-ce2ec8481f5c)
...
> ![image](https://github.com/uni-cs-notes/cs50-notes/assets/160413612/484cad99-a28d-439f-b8e1-aa266c0392f2)
...
> ![image](https://github.com/uni-cs-notes/cs50-notes/assets/160413612/56d6161a-a3e3-41ee-80d5-7a8be1a25b6c)
